...
def get_refund_details(posted_before, posted_after):
	...
	for shipment_event in shipment_event_list:
		shipments = return_as_list(shipment_event.ShipmentEvent)
		for shipment in shipments:
			market_place_order_id = shipment.SellerOrderId
			date_str = shipment.PostedDate
			...
			if customer:
				...
				if shipment:
					shipment_item_list = return_as_list(shipment.ShipmentItemAdjustmentList.ShipmentItem)
					for shipment_item in shipment_item_list:
